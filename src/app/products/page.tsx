...
const Products = () => {
  ...
  <div className="flex flex-col justify-center items-center space-y-8">
    <div className="w-full px-4 md:px-16 flex flex-col items-center">
      <div className="w-full h-auto max-w-2xl mb-4"> {/* Changed max-w-4xl to max-w-2xl */}
        <Image
          src="/images/ClinicalTrials.jpg"
          alt="Supporting Clinical Trials"
          layout="responsive"
          width={900} // Adjusted width for a smaller image
          height={450}  // Adjusted height for a smaller image
          className="object-cover rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300"
        />
      </div>
      <div className="w-full h-auto max-w-2xl px-4 md:px-0 mt-8"> {/* Changed max-w-4xl to max-w-2xl */}
    ...
    <div className="w-full px-4 md:px-16 flex flex-col items-center delay-100">
      <div className="w-full h-auto max-w-2xl mb-4"> {/* Changed max-w-4xl to max-w-2xl */}
        <Image
          ...
          layout="responsive"
          width={900} // Adjusted width for a smaller image
          height={600}  // Adjusted height for a smaller image
          className="object-cover rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300"
        />
      </div>
      <div className="w-full h-auto max-w-2xl px-4 md:px-0 mt-8"> {/* Changed max-w-4xl to max-w-2xl */}
