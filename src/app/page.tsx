...
function MainComponent() {
  return (
    <div className="font-sans bg-secondary text-primary">
      ...
      <section className="h-[640px] relative overflow-hidden">
        <div className="parallax-bg absolute inset-0 w-full h-full bg-cover bg-center" style={{ backgroundImage: 'url("/images/TitleImage.png")' }}></div>
        <div className="absolute inset-0 flex items-center justify-center text-center bg-gradient-to-r from-black to-transparent bg-opacity-70">
          <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-7xl font-extrabold text-primary animate-fadeInUp">
      ...
      <section className="py-12 px-4 md:px-64 bg-gradient-to-br from-gray-900 to-secondary">
        <div className="flex flex-col md:flex-row items-center">
          <img src="/images/brain.webp" alt="AI-driven medical imaging platform" className="w-full md:w-1/2 h-auto mb-8 md:mb-0 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300" />
          <div className="text-center md:w-1/2 animate-fadeInLeft">
            ...
            <button className="bg-primary text-secondary py-2 px-6 rounded shadow-lg hover:bg-accent transition-colors duration-300 animate-fadeInUp">
              Request Demo
            </button>
          </div>
        </div>
      ...
      <section className="py-12 px-4 md:px-64 bg-gradient-to-r from-secondary via-gray-800 to-secondary">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:space-x-8 space-y-8 md:space-y-0">
          <div className="w-full md:w-1/2 px-4 text-center flex flex-col items-center animate-fadeIn">
          ...
          <div className="w-full md:w-1/2 px-4 text-center flex flex-col items-center animate-fadeIn delay-100">
            <div className="flex-grow">
      ...
      <section className="py-12 px-4 md:px-64 bg-gradient-to-br from-secondary to-gray-800">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-evenly space-y-8 md:space-y-0 md:space-x-8">
          <div className="text-center animate-fadeIn">
            <img src="/images/PallaviTiwari.png" alt="Pallavi Tiwari PhD" className="w-[200px] h-[200px] object-cover mx-auto rounded-full mb-4 hover:scale-110 transition-transform duration-300 shadow-lg" />
          ...
          <div className="text-center flex-grow animate-fadeIn delay-100">
            <img src="/images/MikeGalvin.png" alt="Mike Galvin" className="w-[200px] h-[200px] object-cover mx-auto rounded-full mb-4 hover:scale-110 transition-transform duration-300 shadow-lg" />
          ...
          <div className="text-center animate-fadeIn delay-200">
            <img src="/images/JimKarkanias.png" alt="Jim Karkanias PhD" className="w-[200px] h-[200px] object-cover mx-auto rounded-full mb-4 hover:scale-110 transition-transform duration-300 shadow-lg" />
      ...
      <section className="py-12 px-4 md:px-64 bg-secondary text-white">
        <h2 className="text-center text-3xl font-bold mb-8 text-primary animate-fadeInUp">Advisors</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-center animate-fadeIn">
          <div className="text-center">
            <img src="/images/DavidSchuster.webp" alt="David Schuster" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">David Schuster</p>
          </div>
          <div className="text-center">
            <img src="/images/RamyIbrahim.webp" alt="Ramy Ibrahim MD" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">Ramy Ibrahim MD</p>
          </div>
          <div className="text-center">
            <img src="/images/ManmeetAhluwalia.webp" alt="Manmeet Ahluwalia MD" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">Manmeet Ahluwalia MD</p>
          </div>
          <div className="text-center">
            <img src="/images/SarvaChannarajurs.webp" alt="Sarva Channarajurs" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">Sarva Channarajurs</p>
          </div>
          <div className="text-center">
            <img src="/images/GlenTaylor.webp" alt="Glen Taylor" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">Glen Taylor</p>
          </div>
          <div className="text-center">
            <img src="/images/GaryAdey.webp" alt="Gary Adey" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">Gary Adey</p>
          </div>
          <div className="text-center">
            <img src="/images/RebeccaDriscoll.webp" alt="Rebecca Driscoll" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-primary">Rebecca Driscoll</p>
          </div>
          <div className="text-center">
            <img src="/images/JaiKumar.webp" alt="Jai Kumar" className="w-[200px] h-[200px] object-cover mx-auto rounded mb-2 hover:scale-110 transition-transform duration-300 shadow-lg" />
      ...
      <section className="py-12 bg-white">
        ...
        <div className="flex justify-center space-x-48 animate-fadeIn">
          <img src="/images/nvidialogo.webp" alt="NVIDIA logo" className="w-[200px] h-auto hover:scale-110 transition-transform duration-300 shadow-lg" />
          <img src="/images/UWMlogo.webp" alt="University of Wisconsin-Madison logo" className="w-[200px] h-auto hover:scale-110 transition-transform duration-300 shadow-lg" />
          <img src="/images/HandzinLogo.webp" alt="Handzin logo" className="w-[200px] h-auto hover:scale-110 transition-transform duration-300 shadow-lg" />
        </div>
      </section>

      {/* Contact Us Section */}
      <section className="py-12 bg-gray-200">
        <h2 className="text-center text-3xl font-bold mb-4 text-primary animate-fadeInUp">Contact Us</h2>
        <div className="bg-white mx-auto w-full md:w-1/2 p-6 text-center rounded shadow-lg animate-fadeIn">
