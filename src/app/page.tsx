...
function MainComponent() {
  return (
    <div className="bg-secondary text-primary">
      ...
      <section className="py-24 px-4 md:px-64 bg-gradient-to-br from-black to-secondary">
     ...
     {/* Partners Section */}
      <section className="py-12 bg-white">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-16 lg:space-x-48 animate-fadeIn">
